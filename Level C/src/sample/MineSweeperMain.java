...
public class MineSweeperMain extends Application {
    ...
    private Grid game;
    private boolean isMultiGame, restart, pressedF;
    private Label playerAScore, playerBScore, bombsCounter, playerTurn;
    ...
    private VBox gameSetupLayout() {
        ...
        menuLayout.add(playerALabel,0, 1);
        menuLayout.add(forFieldA,1, 1);
        if (isMultiGame) {
            menuLayout.add(playerBLabel,0, 2);
            menuLayout.add(forFieldB,1, 2);
        }
